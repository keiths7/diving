                ...
                <form novalidate action="/user/pay" autocomplete="on" method="POST" id="payment-form">
                    <div class="ui form">          
                        ...
                        <div class="two fields">
                            <div class="field">
                                <input type="tel" class="cc-exp" autocomplete="cc-exp" data-stripe="exp" placeholder="MM/YY" required>
                            </div>
                            <div class="field">
                        ...
                        <div class="field">
                            <input type="tel" placeholder="postalcode" data-numeric  data-stripe="address_zip" class=" cc-postalcode" >
                        </div>

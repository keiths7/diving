...
<section class="profile-tab">
    <div class="ui container">
        <div class="ui four column grid">
            <div class="row">
                <div class="column sel" data-tab="purchases">Purchases</div>
                <div class="column  " data-tab="profile">Profile</div>
                <div class="column " data-tab="setting">Change Password</div>
                <div class="column " data-tab="payment">Payment</div>
            </div>
        </div>
    </div>
</section>
<section class="form-sec profile">
    <div class="ui container">
        <div class="forms-wrap">
                    ...
                    <div class="ui form">
                        ...
                        <div class="inline  fields">
                            ...
                            <div class="five wide field">
                                <div class="ui submit teal large fluid button">Save</div>
                            </div>
                        </div>
                    </div>
              </div>
              ...
              <div class="payment ">  
                     <div class="ui message">
                        <div class="header">Saved Credit Cards </div>
                    </div>     
                    <div class="ui form">
                        <div class="inline  fields">
                            <div class="two wide field">

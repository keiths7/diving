...
<div class="ui modal login-dialog"  >
  ...
  <div class="new-user-tip">
      ...
      <div class="right floated">
        <button class="ui button inverted red">sign up</button>
      </div>
  </div>
</div>
<div class="ui modal signup-dialog"  >
  <i class="close icon"></i>
  <div class="top-header">
    <div class="logo"><img src="/images/logo-black.png" alt=""></div>
    <h3>Book your diving trips all in one place</h3>
  ...
  <div class="new-user-tip clearfix">
      ...
      <div class="right floated">
        <button class="ui button inverted red">sign in</button>
      </div>
  </div>
</div>
